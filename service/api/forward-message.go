...
func (rt *_router) forwardMessage(w http.ResponseWriter, r *http.Request, ps httprouter.Params) {
	...
	rt.baseLogger.Info("received request to forward message with id ", req.From_msg_id, " to the user ", req.To_user)
	...
	if req.Conversation_id == 0 {
		req.Conversation_id, _ = rt.db.GetConversationId(user.Id, req.To_user_id)
	}
	...
	if req.Conversation_id == 0 {
		...
		err = rt.db.CreateConversation(req.Conversation_id, user.Id, req.To_user_id)
		if err != nil {
